/*=======================================================================
	...
	Wall Risk Engine - ENSIMAG version - ENSIMAG module
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREallocSharpeRatio(
	int * nbAssets, double * cov, double * expectedReturns, 
	int * nbEqConst, int * nbIneqConst, double * C, 
	double * b, double * minWeights, double * maxWeights, 
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisExanteModifiedVaR(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisExanteNormalVaR(
	int * nbAssets, double * cov, double * expectedReturns, 
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisExanteReturn(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisExanteVolatility(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisExpostReturn(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisExpostVolatility(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREanalysisGaussianKernel(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREmodelingLogReturns(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREmodelingReturns(
	int * nbValues, int * nbAssets, double * assetsValues, 
	int * horizon, double * assetsReturns, int * info);
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREmodelingSDLScorr(
...
RETURN PARAMETER
	...
	!= 0, see error codes list
*/
extern "C" int WREsimulGeometricBrownianX(
	int * p, int * T, int * N, 
